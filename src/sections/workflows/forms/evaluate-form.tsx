...
export const ActionStepSchema = zod.object({
  ...
  event: zod.string().min(1, { message: 'Please enter an event' }),
});
      ...
      <Form methods={methods} onSubmit={onSubmit}>
        <Stack spacing={4}>
          ...
          <Stack spacing={1}>
            ...
            <Field.Text
              name="event"
              placeholder="e.g. If emergency, when user is in a hurry, etc."
            />
          </Stack>
