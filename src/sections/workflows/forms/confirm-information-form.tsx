...
export const ActionStepSchema = zod.object({
  ...
  info: zod.string().min(1, { message: 'Please specify an info to confirm' }),
});
...
export function ConfirmInformationForm({ step }: Props) {
    ...
    <>
      <Form methods={methods} onSubmit={onSubmit}>
        <Stack spacing={4}>
          ...
          <Stack spacing={1}>
            <Typography variant="body2">Information to Confirm</Typography>
            <Field.Text
              name="info"
              placeholder="e.g. Full address, appointment time, phone number"
            />
          </Stack>
